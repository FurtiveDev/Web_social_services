    ...
    return  [
            {
                ...
                'id': 1,
                'phone_number': '+79774372895',
                'location': 'Москва',
                'support_hours': 'Понедельник - Пятница, 9:00 - 17:00'
            },
            {
...
def GetService(request, id):
    return render(request, 'service.html', {'data' : services_data[id-1]['description'],'imag': services_data[id-1]['image'], 'phone_number': services_data[id-1]['phone_number'], 'location': services_data[id-1]['location'] ,'support_hours': services_data[id-1]['support_hours']
    })